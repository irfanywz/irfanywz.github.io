...
description: "Prompt builder untuk menghasilkan sheet grid 6 ekspresi emosi karakter 2D (Neutral, Crying, Angry, Sad, Closed Eye, Confused) dengan konsistensi bentuk wajah dan gaya animasi"
...
<input type="text" x-model="emotionStyle" @focus="$el.select()" placeholder="e.g. Standard clean 6-pose character emotion grid sheet..." class="w-full bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-xl pl-3 pr-10 py-2 text-sm text-gray-800 dark:text-gray-200 focus:outline-none focus:border-indigo-500">
...
<input type="text" x-model="emotionInputNote" @focus="$el.select()" placeholder="Ex: Standard clean 6-pose character emotion grid sheet..." class="w-full bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-xl px-3 py-2 text-xs text-gray-800 dark:text-gray-200 focus:outline-none focus:border-indigo-500">
</div>
...
function characterEmotionApp() {
    return {
        emotionStyle: 'Standard clean 6-pose character emotion grid sheet with Neutral, Crying, Angry, Sad, Closed Eye, and Confused expressions. Output Just Head',
        emotionInputNote: 'STANDARD CLEAN 6-POSE CHARACTER EMOTION GRID SHEET',
        ...
        emotionDatabase: {
            "Standard Grid": [
                ...
                },
                {
                    ...
                    description: "Minimalist layout of 6 core emotional expressions for precise character mood storytelling.",
            ...
            "Animation Style": [
                {
                    ...
                    description: "Clean vector cartoon style 6-expression facial asset sheet for 2D animation rig.",
                ...
                },
                {
                    ...
                    description: "Slightly handmade line quality character emotion chart featuring 6 subtle facial variations.",
        ...
        get dynamicEmotionBasePrompt() {
            let target = this.emotionInputNote ? this.emotionInputNote.trim() : 'STANDARD CLEAN 6-POSE CHARACTER EMOTION GRID SHEET';
...
- OUTPUT EXACTLY ONE SENTENCE.`;
        ...
        get fullPrompt() {
            let styleDesc = this.emotionStyle ? this.emotionStyle.trim() : 'Standard clean 6-pose character emotion grid sheet.';
